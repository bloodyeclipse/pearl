...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `tenants` WHERE CONCAT(`name`, `surname`, `apartment`, `hnumber`, `phone`) LIKE '%".$valueToSearch."%'";
...
section {
  ...
  <li><a href="payment1.html"><i class="fas fa-link"></i>PAYMENTS</a></li>
          ...
          <li><a href="C\wamp64\www\services1.php"><i class="fas fa-sliders-h"></i>Services</a></li>
 ...
 <section>
  <form action="aa2.php" method="post">
     <br><br><br>
