 ...
 <section>
  <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
     ...
     <h2 class="title">Registration Form</h2>
           ...
           <form action="contsecurity.php" method="post">
...
<label class="label">Security ID</label>
 ...
 <input class="input--style-4" type="text" name="securityID">
   ...
   <label class="label">Apartment name</label>
      ...
      <div class="rs-select2 js-select-simple select--no-search">
               ...
               <option disabled="disabled" selected="selected">Choose option</option>
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit" name="submit2">Submit</button>
                        </div>
             ...
             <a href="managerservices.php"
                            <button " type="" name="back" ">back</button> </a>
        </div>
    </div>
