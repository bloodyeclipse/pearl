                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="info-box">
                                    <i class="bx bx-map"></i>
                                    <h3>Our Address</h3>
                                    <p>72 Sheffield street,Kenilworth 2190</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Email Us</h3>
                                    <p>pealpms@gmail.com<br>nyonishania@gmail.com</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Call Us</h3>
                                    <p>+27622985348<br>+27822826754073
                </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form action="contact.php" method="post">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="text" name="Tenant_Id" class="form-control" id="name" placeholder="Tenant ID" required>
                                </div>
