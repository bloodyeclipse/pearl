...
<label class="label">House Number</label>
 ...
 <input class="input--style-4" type="text" name="hnumber">
...
<label class="label">Visitor ID number</label>

 <input class="input--style-4" type="text" name="visitorid">
   ...
   <label class="label">Apartment name</label>
      ...
      <div class="rs-select2 js-select-simple select--no-search">
               ...
               <option disabled="disabled" selected="selected">Choose option</option>
                                    <option>Softlife apartment</option>
                                    <option>lily gardens</option>
