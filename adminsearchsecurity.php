...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `security` WHERE CONCAT(`securityID`, `name`, `surname`,`gender`, `apartment`, `phone`,`password`, `email`) LIKE '%".$valueToSearch."%'";
...
section {
 ...
 <section>
   <h1>Search for security</h1>

        <!-- TABLE CONSTRUCTION -->

        <form action="adminsearchsecurity.php" method="post">
    ...
    <tr>
                ...
                ?>
                        ...
                        <tr>
                                ...
                                <td><?php echo $rows["securityID"];?></td>
