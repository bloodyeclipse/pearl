...
section {
 ...
 <li><a href="landingpage.php"><i class="far fa-envelope"></i>logout</a></li>
      </ul>
 ...
 <section>
  <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
     ...
     <h2 class="title">Maintanence Request</h2>



           <form action="securityconnect.php" method="post">
...
<label class="label">Security ID</label>
 ...
 <input class="input--style-4" type="text" name="idname">
...
<div class="row row-space">
   ...
   <label class="label">type_of_maintenance</label><br>
      ...
      <div class="rs-select2 js-select-simple select--no-search">
             ...
             <br>  <option disabled="disabled" selected="selected">Choose type_of_maintenance</option>
    ...
    <script src="js/global.js"></script></section>
