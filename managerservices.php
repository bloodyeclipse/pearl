            ...
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            <a class="h3 d-block mb-3" href="registertenant.php">Register Tenant</a>
...
<div class="d-flex justify-content-between border-top p-4">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        ...
                        <div class="p-4">
                            <a class="h3 d-block mb-3" href="adminsearchsecurity.php">Search Security</a>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="bg-light rounded overflow-hidden">
                        <img class="img-fluid w-100" src="Search.png" alt="">
                        <div class="p-4">
                            <a class="h3 d-block mb-3" href="adminsearchtenant.php">Search tenant</a>
